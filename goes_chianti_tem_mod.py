...
__all__ = ["calculate_temperature_em_mod"]

MAX_SUPPORTED_SATELLITE = 17


def calculate_temperature_em_mod(goes_ts, abundance="coronal"):
    """
...
def _chianti_temp_emiss(
    ...
    longflux = goes_ts.quantity("xrsb_diff").to(u.W / u.m**2)
    shortflux = goes_ts.quantity("xrsa_diff").to(u.W / u.m**2)
